    ...
    while cap.isOpened():
        ...
        if results.multi_hand_landmarks:
            for hand_landmarks in results.multi_hand_landmarks:
                ...
                fingertip_indices = [4, 8, 12, 16, 20]  # 엄지~새끼
                padding_x = 20
                padding_y = 40
                threshold_distance = 20

                for i, idx in enumerate(fingertip_indices):  # i: 0~4
                    ...
                    cv2.putText(image, finger_number, (fx - 10, fy - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
                    ...
                    if best_shadow_point:
                        ...
                        if dist < threshold_distance:
                            cv2.putText(image, "Touch", (fx - 10, fy + 30), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 255, 0), 2)
